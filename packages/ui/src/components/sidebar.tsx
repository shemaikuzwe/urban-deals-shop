...
import { Sheet, SheetContent } from "@urban-deals-shop/ui/components/sheet";
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 relative h-svh group-data-[state=expanded]:w-(--sidebar-width) bg-transparent transition-[width] ease-linear",
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-svh group-data-[state=expanded]:w-(--sidebar-width) transition-[left,right,width] ease-linear md:flex",
            side === "left"
